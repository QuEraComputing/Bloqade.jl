...
The Rydberg Hamiltonian is generally specified by atom positions ``\overrightarrow{\mathbf{r}_j}``, Rabi frequencies ``\Omega_j``, laser phase ``\phi_j``, and detunings ``\Delta_j``. In Bloqade, 
