...
# Please refer to the [Rydberg Blockade](https://queracomputing.github.io/Bloqade.jl/dev/tutorials/1.blockade/main/) page on how to set the separation distance for preparing the ordered states.
