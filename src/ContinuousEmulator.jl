...
function RydbergEmulator.emulate!(r::Yao.ArrayReg, t::Real, h::AbstractTerm; algo=Vern8(), cache=SparseMatrixCSC(h(1e-2)), kwargs...)
...
function RydbergEmulator.emulate!(r::RydbergReg, t::Real, h::AbstractTerm; algo=Vern8(), cache=SparseMatrixCSC(h(1e-2), r.subspace), kwargs...)
