...
YaoArrayRegister.state(reg::SubspaceReg) = reg.state
YaoArrayRegister.statevec(reg::SubspaceReg) = YaoArrayRegister.matvec(reg.state)
YaoArrayRegister.relaxedvec(reg::SubspaceReg{1}) = vec(reg.state)
YaoArrayRegister.relaxedvec(reg::SubspaceReg) = reg.state
